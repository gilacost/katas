...
'1_slices_of_one_from_one_test_'() ->
    {"slices of one from one", ?_assertEqual(["1"], series:slices(1, "1"))}.

'2_slices_of_one_from_two_test_'() ->
    {"slices of one from two", ?_assertEqual(["1", "2"], series:slices(1, "12"))}.

'3_slices_of_two_test_'() ->
    {"slices of two", ?_assertEqual(["35"], series:slices(2, "35"))}.
...
'7_slice_length_is_too_large_test_'() ->
    {"slice length is too large", ?_assertError(_, series:slices(6, "12345"))}.

'8_slice_length_cannot_be_zero_test_'() ->
    {"slice length cannot be zero", ?_assertError(_, series:slices(0, "12345"))}.

'9_slice_length_cannot_be_negative_test_'() ->
    {"slice length cannot be negative", ?_assertError(_, series:slices(-1, "123"))}.

'10_empty_series_is_invalid_test_'() ->
    {"empty series is invalid", ?_assertError(_, series:slices(1, []))}.
